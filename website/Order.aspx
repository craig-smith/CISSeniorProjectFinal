...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">   
   <asp:Repeater ID="rptOrderItem" runat="server">
       ...
       <ItemTemplate>
           ...
           <div class="order-item-ordered">Amount Ordered: <asp:TextBox ID="txtCount" runat="server" ClientIDMode="Predictable" EnableViewState="true" ValidationGroup="calculate"></asp:TextBox></div>
               <div class="error-msg">
                   <asp:RequiredFieldValidator ID="itemCountRequiredValidator" runat="server" ErrorMessage="Item Count is required." ControlToValidate="txtCount" ValidationGroup="calculate"></asp:RequiredFieldValidator>
                   <asp:CompareValidator ID="itemCountCompareValidator" runat="server" ErrorMessage="You must enter a whole number." Operator="GreaterThanEqual" ValueToCompare="0" Type="Integer" ControlToValidate="txtCount" ValidationGroup="calculate"></asp:CompareValidator>
               </div>
           </div>
       </ItemTemplate>
       <FooterTemplate>
    ...
    <div id="paymentMethod">
        ...
        <div>
            <asp:Button ID="btnCalculateOrder" Text="Calculate Order" runat="server" OnClick="btnCalculateOrder_Click" ValidationGroup="calculate" />
